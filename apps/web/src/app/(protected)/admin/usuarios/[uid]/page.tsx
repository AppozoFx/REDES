  ...
  return (
    <div className="space-y-5 text-slate-900 dark:text-slate-100">
      ...
      >
        ...
        <button className="rounded-lg border border-slate-300 px-4 py-2 text-sm transition hover:bg-slate-100 dark:border-slate-600 dark:hover:bg-slate-800">
          Guardar acceso
        </button>
      </form>
      ...
      {accesoHabilitado ? (
        ...
        >
          ...
          <button className="rounded-lg border border-rose-400 px-4 py-2 text-sm text-rose-700 transition hover:bg-rose-100 dark:border-rose-700 dark:text-rose-300 dark:hover:bg-rose-900/40">
            Deshabilitar
          </button>
        </form>
      ) : (
        ...
        >
          ...
          <button className="rounded-lg border border-amber-500 px-4 py-2 text-sm transition hover:bg-amber-100 dark:border-amber-700 dark:hover:bg-amber-900/40">
            Habilitar
          </button>
        </form>
      )}
