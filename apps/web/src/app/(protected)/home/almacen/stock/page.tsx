...
import HomeAlmacenStockClient from "./HomeAlmacenStockClient";

export const dynamic = "force-dynamic";

export default async function HomeAlmacenStockPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Stock de Almacen</h1>
      </section>
      <HomeAlmacenStockClient />
    </div>
  );
}
