    ...
    <div className="space-y-4">
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Almacen - Materiales</h1>
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Consulta, filtra y edita materiales de forma rapida.</p>
          </div>
