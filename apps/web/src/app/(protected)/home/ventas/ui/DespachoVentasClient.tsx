        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div>
            ...
            {canEditCoordinador ? (
              ...
              <input value={coordinadorNombre} readOnly className="ui-input-inline ui-input-inline mt-1 w-full rounded-xl border border-slate-200 bg-slate-100 px-3 py-2 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200" />
            )}
          </div>
          <div>
          ...
          <div>
            ...
            <input value={cuadrillaNombre} readOnly className="ui-input-inline ui-input-inline mt-1 w-full rounded-xl border border-slate-200 bg-slate-100 px-3 py-2 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200" />
          </div>
        </div>
      </div>
