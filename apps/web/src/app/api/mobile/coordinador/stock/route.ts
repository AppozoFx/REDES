...
export async function GET(req: Request) {
  try {
    ...
    const cuadrillas = equiposSnaps.map(({ cuadrillaId, cuadrillaNombre, snap }) => {
      ...
      return { cuadrillaId, cuadrillaNombre, ...counts, total: counts.ont + counts.mesh + counts.fono + counts.box, equipos };
