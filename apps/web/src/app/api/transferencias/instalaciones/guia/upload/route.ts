...
export async function POST(req: Request) {
  try {
    ...
    const tipo = ["despacho", "devolucion", "ventas", "actas", "tecnicos-materiales", "reposicion", "despacho-personal", "devolucion-personal", "transferencia-interna"].includes(tipoRaw) ? tipoRaw : "despacho";
